...
export default function JarvisApp({ initialView = 'assistant' }: { initialView?: View }) {
  ...
  return <div className="app-shell"><SmoothScroll /><div className="site-dot-background"><OriginalDotField /></div>
    ...
    <main className={`main-content view-${view} ${messages.length ? 'has-messages' : ''}`}>
      ...
      {view === 'assistant' && <>
        {messages.length === 0 ? <div className="welcome-view"><div className="hero original-hero"><div className="hero-glow" /><div className="hero-content"><DepthLogo text="Jarvis" fontSize="clamp(4.5rem, 10vw, 7rem)" /></div><span className="hero-coordinate">43°14′ N / 76°53′ E</span><span className="hero-corner">J / 01</span></div>
