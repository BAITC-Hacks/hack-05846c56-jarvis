...
export default function JarvisApp({ initialView = 'assistant' }: { initialView?: View }) {
  ...
  return <div className="app-shell"><SmoothScroll /><div className="site-dot-background"><OriginalDotField /></div>
