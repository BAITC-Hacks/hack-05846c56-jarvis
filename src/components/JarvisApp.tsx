...
type DisplayMessage = ChatMessage & { specification?: ChatResponse['specification']; id: string; products?: Product[]; sources?: ChatResponse['sources']; suggestions?: string[]; attachments?: string[]; proposedItems?: ChatResponse['proposedItems']; mode?: ChatResponse['mode'] };
